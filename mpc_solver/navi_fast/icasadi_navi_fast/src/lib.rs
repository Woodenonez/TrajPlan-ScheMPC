...
extern "C" {
    fn init_interface_navi_fast();
    fn cost_function_navi_fast(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double) -> c_int;
    fn grad_cost_function_navi_fast(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double)
        -> c_int;
    fn mapping_f1_function_navi_fast(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn mapping_f2_function_navi_fast(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    // Compute all preconditioning parameters
    fn preconditioning_www_navi_fast (
        arg: *const *const c_double,
    ) -> c_int;
    fn init_penalty_function_navi_fast(
        arg: *const *const c_double,
        ipnlt: *mut *mut c_double,
    ) -> c_int;
    fn get_w_cost_navi_fast() -> c_double;
} // END of extern C
...
pub fn precondition(
    ...
    let arguments = &[u.as_ptr(), static_params.as_ptr()];
    unsafe {
         preconditioning_www_navi_fast(arguments.as_ptr()) as i32
    }
}
...
pub fn initial_penalty(
    ...
    // preconditioning_init_penalty_function_navi_fast
    let arguments = &[u.as_ptr(), static_params.as_ptr()];
    let ip = &mut [rho_init as *mut c_double];

    unsafe {
         init_penalty_function_navi_fast(
            arguments.as_ptr(),
            ip.as_mut_ptr(),
        ) as i32
    }
